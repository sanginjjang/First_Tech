...
public class ResumeDetailController {
	...
	@RequestMapping("resumeDetailView_joontaek/{resumeNum}")
	public String resumeDetailView_joontaek(@PathVariable("resumeNum") int resumeNum,
			  Model model) {
		
		System.err.println(resumeNum);
		System.err.println(resumeNum);
		System.err.println(resumeNum);
		System.err.println(resumeNum);
		System.err.println(resumeNum);
		...
		return "/taek/resumeViewDetails_taek";
	}
}
